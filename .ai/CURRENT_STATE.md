...
- `lib/styles.ts`: all 31 style objects and their prompt modes.
...
- `public/examples/`: 19 benchmark/user-provided sources and 36 preserved development/release outputs, delivered as optimized WebP assets.
...
- `examples`: typed input-image and output-image pairs; all 31 styles now point to official GPT-5.5 即時 results.
...
- All 31 style examples reference existing assets.
- The repository contains 55 optimized WebP example assets.
