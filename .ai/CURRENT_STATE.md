...
- `lib/styles.ts`: all 37 style objects and their prompt modes.
...
- `public/examples/`: 24 benchmark/user-provided sources and 42 preserved development/release outputs, delivered as optimized WebP assets.
...
- `examples`: typed input-image and output-image pairs; all 37 styles now point to official GPT-5.5 即時 results. Text-only styles intentionally use an empty input-image list.
...
- All 37 style examples reference existing assets.
- The repository contains 66 optimized WebP example assets.
