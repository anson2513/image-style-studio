...
- `lib/styles.ts`: all 32 style objects and their prompt modes.
...
- `public/examples/`: 20 benchmark/user-provided sources and 37 preserved development/release outputs, delivered as optimized WebP assets.
...
- `examples`: typed input-image and output-image pairs; all 32 styles now point to official GPT-5.5 即時 results.
...
- All 32 style examples reference existing assets.
- The repository contains 57 optimized WebP example assets.
