...
- `lib/styles.ts`: all 38 style objects and their prompt modes.
...
- `public/examples/`: 25 benchmark/user-provided sources and 43 preserved development/release outputs, delivered as optimized WebP assets.
...
- `examples`: typed input-image and output-image pairs; all 38 styles now point to official GPT-5.5 即時 results. Text-only styles intentionally use an empty input-image list.
...
- All 38 style examples reference existing assets.
- The repository contains 68 optimized WebP example assets.
