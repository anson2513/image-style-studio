    ...
    },
{
  ...
  prompt: `請將我上傳的 3–4 張照片視為同一組攝影作品（Photo Series）。
...
* Independent Publishing Designer
* Art Book Designer
...
（Editorial Photography Book Spread）
...
生成一組真正具有出版價值的高級攝影畫冊跨頁。

讓人感覺：

這是一本來自東京、首爾、哥本哈根或巴黎獨立出版社發行的攝影書。
...
overdetailed rendering`,
    ...
    {
      category: '電影宇宙',
      cover: '/examples/outputs/dappled-cinematic-light/dappled-cinematic-light-chatgpt-5-5-instant-01.webp',
      name: '斑駁光影電影感',
      promptMode: 'independent',
      desc: 'Dappled Cinematic Light',
      prompt: `保持原構圖與主體位置不變。 超寫實電影風格，光影瞬間增強，地面與牆面呈現清晰的斑駁光斑。 冷暖色對比明顯，畫面飽和度保持自然真實。 前景輕微動態模糊，增強空間縱深感，電影開場鏡頭質感。`,
    },
    {
...
具有博物館典藏、藝術畫廊展覽、國際攝影獎得獎作品與收藏級藝術輸出的完成度，而非一般數位模糊或 AI 特效`,
    ...
    {
      category: '食物美學',
      cover: '/examples/outputs/afternoon-window-light-food/afternoon-window-light-food-chatgpt-5-5-instant-01.webp',
      name: '午後窗光輕食時光',
      promptMode: 'independent',
      desc: 'Warm Window Light Food Photography',
      prompt: '保持圖片結構不變，整體為暖調自然光色系。 側前方 45° 斜射的自然光（類似午後窗邊的漫射光），光線透過窗櫺形成條狀光影，在木桌上投射出規律的陰影，增強了畫面的肌理感與氛圍感。 整體氛圍是溫暖、清新、治癒且充滿煙火氣的，像午後陽光下的一場愜意輕食時光。',
    },
    {
      category: '食物美學',
      cover: '/examples/outputs/premium-food-branding/premium-food-branding-chatgpt-5-5-instant-01.webp',
      name: '精品食物品牌廣告',
      promptMode: 'independent',
      desc: 'Premium Food Branding Campaign',
      prompt: `@創作圖像 請先分析我上傳的真實食物照片。
...
Premium Food Branding Campaign
Luxury Restaurant Advertising
Editorial Food Photography
High-End Food Poster

━━━━━━━━━━

【核心創意方向】

將原始料理升級為具有國際品牌價值的商業視覺作品。
...
Cereal Magazine
Aesop Campaign
Apple Advertising Minimalism
Japanese Food Editorial
Nordic Editorial Design
Luxury Restaurant Branding
Premium Food Campaign
...
premium food branding campaign,
luxury restaurant advertising,
editorial food poster,
award-winning commercial photography,
floating ingredients,
food styling masterclass,
...
而不是一般 AI 圖片。`,
    ...
    {
      category: '手繪插畫',
      cover: '/examples/outputs/naive-handwritten-poetry-poster/naive-handwritten-poetry-poster-chatgpt-5-5-instant-01.webp',
      name: '笨拙手寫詩意海報',
      promptMode: 'independent',
      desc: 'Naive Handwritten Poetry Poster',
      prompt: `角色定位

你是一位國際級東方視覺設計師（Editorial Designer）、手寫字體設計師（Hand Lettering Artist）、自然主義插畫藝術總監（Natural Illustration Director）與獨立出版美術指導（Independent Publishing Art Director）。

你的任務不是製作商業廣告，而是創作一張具有文學感、留白感與真實手作溫度的極簡文字海報。

整體作品應像一本獨立出版物、一頁攝影書、一本詩集、一張展覽海報，具有克制、安靜、自然的視覺節奏。
...
最終效果應像一張值得收藏的獨立出版海報，而不是經過過度設計的商業作品。
...
const styleDetails: Record<Style['name'], StyleDetails> = {
  ...
  '午後窗光輕食時光': {
    summary: '保持原始餐桌構圖，加入午後窗邊暖調自然光、窗櫺條狀陰影與木桌肌理，營造清新治癒的輕食時光。',
    tags: ['午後窗光', '暖調自然光', '條狀光影', '輕食氛圍'],
    inputType: 'single-image',
  },
  '視覺導演': {
  ...
  '斑駁光影電影感': {
    summary: '保留原始構圖與主體位置，強化牆面與地面的自然光斑、冷暖對比與前景動態模糊，形成電影開場鏡頭般的超寫實街景質感。',
    tags: ['斑駁光影', '電影開場', '冷暖對比', '前景動態'],
    inputType: 'single-image',
  },
  '高級旅遊雜誌風': {
...
const styleExamples: Partial<Record<Style['name'], Style['examples']>> = {
  ...
  '笨拙手寫詩意海報': [
    {
      inputImages: [],
      outputImage: '/examples/outputs/naive-handwritten-poetry-poster/naive-handwritten-poetry-poster-chatgpt-5-5-instant-01.webp',
    },
  ],
  '品牌主視覺企劃': [
    {
  ...
  '精品食物品牌廣告': [
    {
      ...
      outputImage: '/examples/outputs/premium-food-branding/premium-food-branding-chatgpt-5-5-instant-01.webp',
    },
  ],
  '午後窗光輕食時光': [
    {
      inputImages: ['/examples/sources/afternoon-window-light-food/afternoon-window-light-food-01.webp'],
      outputImage: '/examples/outputs/afternoon-window-light-food/afternoon-window-light-food-chatgpt-5-5-instant-01.webp',
    },
  ],
  ...
  '斑駁光影電影感': [{ inputImages: ['/examples/sources/dappled-cinematic-light/dappled-cinematic-light-01.webp'], outputImage: '/examples/outputs/dappled-cinematic-light/dappled-cinematic-light-chatgpt-5-5-instant-01.webp' }],
